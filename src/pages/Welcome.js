...
const Welcome = ({ categories, onSelect }) => {
  ...
  return (
    <div ref={containerRef} className="welcome relative min-h-screen flex flex-col items-center justify-center text-center">
      ...
      <div className="relative z-10 w-full flex justify-center py-6">
        <img src={logo} alt="Logo" className="w-32 h-auto drop-shadow-[0_0_12px_rgba(255,255,255,0.9)]" />
      </div>
